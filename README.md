...
<p>
  <img src="https://komarev.com/ghpvc/?username=Anushesh88&label=Profile%20Views&color=blueviolet&style=for-the-badge" alt="Profile Views" />
  <img src="https://img.shields.io/github/followers/Anushesh88?label=Followers&style=for-the-badge&color=blue" alt="Followers" />
  <img src="https://img.shields.io/badge/Focus-Computer%20Vision-brightgreen?style=for-the-badge" alt="Focus" />
  <img src="https://img.shields.io/badge/Lives-India-orange?style=for-the-badge" alt="Lives" />
  <img src="https://img.shields.io/badge/Languages-Python%20%7C%20C%2B%2B-yellow?style=for-the-badge" alt="Languages" />
</p>
...
const anushesh = {
    ...
    cv_tools: ["OpenCV", "YOLO", "U-Net", "ResNet50"],
    education: {
        degree: "B.Tech",
        university: "IIT Kharagpur",
        school: "JNV Yavatmal"
    },
    interests: ["Computer Vision", "Data Science", "NLP", "Robotics"],
    projects: [
        "Image Caption Generator (ResNet50 + LSTM)",
        "Tuberculosis Bacteria Detection (Cascade R-CNN)",
        "Stock Price Predictor (Dual-Branch LSTM)",
        "Yeast Cell & Grain Boundary Detection"
    ],
    leadership: "Finance Team Lead at NSSC 2024",
    contact: "anusheshjumale88@gmail.com"
};
```
...
- 🧠 Specializing in Computer Vision, tackling architectures like Cascade R-CNN, U-Net, and ResNet.
- 💼 Organized and led the finance team for the National Students' Space Challenge (NSSC).
- 🔬 Active projects include an Image Caption Generator, medical image segmentation, and stock price prediction.
- 🔧 Proficient in Python, PyTorch, TensorFlow, OpenCV, C++.
- 📫 Reach me: anusheshjumale88@gmail.com
- 🎯 Focus: Deep Learning architectures, seeking remote opportunities, and continuous growth.
</div>
...
<br>
**<img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Glowing%20Star.png" width="25" height="25" /> Crafted with passion by <a href="https://github.com/Anushesh88">Anushesh</a> <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Travel%20and%20places/Glowing%20Star.png" width="25" height="25" />**
